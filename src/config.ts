...
export const PROJECT_NAME = 'Ordinary Differential Equations'
// used for landing page heading and nav home link

export const SITE = {
  title: 'Ordinary Differential Equations',
  description: 'Projects related to solving ODE using numerical techniques',
...
export const GITHUB_REPO_URL = 'https://github.com/OjasRane/Ordinary-Differential-Equations'
